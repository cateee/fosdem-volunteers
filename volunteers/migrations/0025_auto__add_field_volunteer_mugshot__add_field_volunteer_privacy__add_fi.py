...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('volunteers_volunteer', 'mugshot')

        # Deleting field 'Volunteer.privacy'
        db.delete_column('volunteers_volunteer', 'privacy')

        # Deleting field 'Volunteer.language'
        db.delete_column('volunteers_volunteer', 'language')
    ...
    models = {
        ...
        'volunteers.task': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'edition': ('django.db.models.fields.related.ForeignKey', [], {'default': '3', 'to': "orm['volunteers.Edition']"}),
            'end_time': ('django.db.models.fields.TimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
