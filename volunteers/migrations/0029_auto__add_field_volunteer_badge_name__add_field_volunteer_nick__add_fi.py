...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volunteer.badge_name'
        db.add_column('volunteers_volunteer', 'badge_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)

        # Adding field 'Volunteer.nick'
        db.add_column('volunteers_volunteer', 'nick',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16),
                      keep_default=False)

        # Adding field 'Volunteer.contact_email'
        db.add_column('volunteers_volunteer', 'contact_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volunteer.badge_name'
        db.delete_column('volunteers_volunteer', 'badge_name')

        # Deleting field 'Volunteer.nick'
        db.delete_column('volunteers_volunteer', 'nick')

        # Deleting field 'Volunteer.contact_email'
        db.delete_column('volunteers_volunteer', 'contact_email')
    ...
    models = {
        ...
        'volunteers.volunteer': {
            'Meta': {'ordering': "['nick', 'badge_name']", 'object_name': 'Volunteer'},
            'about_me': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'badge_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32'}),
            ...
            'nick': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '16'}),
