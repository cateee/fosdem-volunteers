...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'volunteers_volunteer', 'mugshot',
                      self.gf('django.db.models.fields.files.ImageField')(default='/foo.png', max_length=100, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'volunteers.task': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'edition': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['volunteers.Edition']"}),
            'end_time': ('django.db.models.fields.TimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
